...
func demoSections() -> [DemoSection] {
    [
        ...
        // The app shell itself — menu bar and window chrome — authored in React.
        DemoSection(title: "React Shell", symbol: "menubar.rectangle", source: .plugin(id: "menu-demo")),
...
private func iconChip(_ id: String, _ symbol: String) -> UINode {
    styled(
        ...
        style: [
            ...
            "shadow": .object([
                "offsetX": .number(0), "offsetY": .number(8),
                "radius": .number(16), "color": .string("brand/26"),
            ]),
        ],
